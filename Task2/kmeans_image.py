...
plt.imshow(img_rgb)
#plt.savefig('../Report/figures/fig_2.2_peppers.eps', dpi=100, format='eps')
plt.show()
img = cv2.cvtColor(img, cv2.COLOR_BGR2LAB)

# cols = np.zeros((img.shape[0], img.shape[1], 2), dtype=np.uint8)
...
plt.imshow(img)
#plt.savefig('../Report/figures/fig_2.2_p_3d5.eps', dpi=100, format='eps')
plt.show()
